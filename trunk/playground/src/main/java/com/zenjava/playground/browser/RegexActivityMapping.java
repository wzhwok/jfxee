 ...
 */
public class RegexActivityMapping implements ActivityMapping
{
     ...
     * @param activity the Activity that this mapping is for.
     */
    public RegexActivityMapping(String expression, Activity activity)
    {
    ...
    {
        return pattern.matcher(place.getName()).matches();
    }

    /**
     * Retrieves the regular expression used by this mapping.
     *
     * @return the regulard expression used by this mapping.
     */
    ...
    /**
     * Retrieves the Activity that this mapping is for.
     *
     * @return the Activity that this mapping is for.
     */
